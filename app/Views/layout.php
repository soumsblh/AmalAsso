...
<head>
    ...
    <?php if (($w_current_route === "panel_profil_profilSuperAdmin") || ($w_current_route === "panel_profil_profilAdmin")) :?>
...
<section>
    ...
    <?php if (($w_current_route == "panel_profil_profilSuperAdmin") || ($w_current_route == "panel_profil_profilAdmin")) :?>
        <?= debug(!$w_current_route == "panel_profil_profilSuperAdmin" || $w_current_route == "panel_profil_profilAdmin")?>
    <footer>
...
<?php if ($w_current_route == 'panel_profil_profilAdmin'&&'panel_profil_profilSuperAdmin'&&'panel_profil_profilDonateur'): ?>
